...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_efficient_b7_fpn_1x_leakage'
# './work_dirs/cascade_rcnn_x101_64x4d_fpn_1x/epoch_12.pth'
load_from = None
# load_from = './work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_leakage/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
